    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black text-white">
      <nav className="fixed top-0 left-0 w-full z-50 bg-black/40 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-6xl mx-auto flex justify-center gap-8 py-4 text-sm tracking-widest">
          ...
          <a href="#release" className="hover:text-gray-400 transition">
            RELEASE
          </a>
          <a href="#shows" className="hover:text-gray-400 transition">
            SHOWS
          </a>
      ...
      <section id="bio" className="max-w-6xl mx-auto px-10 py-24">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 text-sm">
            <div>
              <p className="text-gray-500 tracking-widest mb-2">GENRE</p>
              <p>Metalcore</p>
            </div>
            <div>
              <p className="text-gray-500 tracking-widest mb-2">LOCATION</p>
              <p>Paris, France</p>
            </div>
            <div>
              <p className="text-gray-500 tracking-widest mb-2">FOR FANS OF</p>
              <p>Architects, Currents, Polaris</p>
            </div>
            <div>
              <p className="text-gray-500 tracking-widest mb-2">STATUS</p>
              <p>EP Coming Soon</p>
            </div>
          </div>
        </div>
      ...
      {/* SHOWS */}
      <section id="shows" className="max-w-6xl mx-auto px-10 py-24">
        <h2 className="text-3xl text-center tracking-[0.3em] mb-16">
          SHOWS
        </h2>
        
        {/* Conteneur du Widget Bandsintown avec TES paramètres */}
        <a 
